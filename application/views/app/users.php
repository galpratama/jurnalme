      ...
      <form class="form-horizontal" role="form">
	      <div class="modal-body">
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input required type="text" class="form-control" id="input_name" placeholder="Nama" value="<?php echo $users_edit->users_name;?>">
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="input_email" class="col-sm-2 control-label">Email</label>
			    <div class="col-sm-10">
			      <input required type="email" class="form-control" id="input_email" placeholder="Email" value="<?php echo $users_edit->users_mail;?>">
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="input_password" class="col-sm-2 control-label">Password</label>
			    <div class="col-sm-10">
			      <input required type="password" class="form-control" id="input_password" placeholder="Password" value="<?php echo $users_edit->users_pass;?>">
			    </div>
			  </div>
